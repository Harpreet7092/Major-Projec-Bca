        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    ...
                    <h4 style="color: black;"><?php echo isset($_SESSION['Username']) ? $_SESSION['Username'] : ''; ?></h4>
                    <br>
                </center>
                </header>
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <font size="+1"><?php echo isset($_SESSION['Email']) ? $_SESSION['Email'] : ''; ?></font>
                        </div>
                        <div class="col-sm-3"></div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <font size="+1"><?php echo isset($_SESSION['Mobile']) ? $_SESSION['Mobile'] : ''; ?></font>
                        </div>
                        <div class="col-sm-3">
                            <b><font size="+1" color="black">ADDRESS : </font></b>
                            <font size="+1"><?php echo isset($_SESSION['Addr']) ? $_SESSION['Addr'] : ''; ?></font>
                        </div>
                        <div class="col-sm-3"></div>
                    </div>
                        <div class="12u$">
