<?php
    ...
    // $where=$_SESSION['id'];
    // $sql = "SELECT * FROM farmer WHERE bid='$where'";
...
<section>
							...
							<form method="post" action="updateProfile.php">
								...
								<div class="row uniform">
									<div class="3u 12u$(xsmall)">
										<input type="text" name="mobile" id="mobile" value="<?php  echo $_SESSION['Mobile']; ?>" placeholder="Mobile Number" required/>
									</div>
								...
								<div class="row uniform">
									<div class="6u 12u$(xsmall)">
										<input type="text" name="addr" id="addr" value="<?php  echo $_SESSION['Addr']; ?>" placeholder="Address" style="width:80%" required/>
									</div>
								</div>
								<div class="row uniform">
									<!-- <p>
			                        ...
			                        <!-- <div class="3u 12u$(small)">
			                            <input type="radio" id="farmer" class="cat" name="category" value="1" checked>
			                            <label for="farmer">Farmer</label>
			                        </div>
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id="buyer" class="cat" name="category" value="0">
